...
<div class="container">
  ...
  <nav>
    ...
    <aside>
      <p>This is Login Welcome Page.</p>
    </aside>
  <!-- end .sidebar1 --></div>
...
<section>
     ...
     <p>University Health centre is planning to improve communication with students by developing a new program utilizing MySQL &amp; PHP </p>
    </section>
    <section>
      <h2>&nbsp;</h2>
      <p><?php 
	  /* 
	  if (!function_exists(priorityFunc)){
